...
description: |
  ...
  4. 如果 plus-ui/ 目录存在则包含前端代码（Vue 3 + Element Plus）
---
...
| 层级 | 技术栈 | 版本 | 说明 |
|------|--------|------|------|
| **后端框架** | Spring Boot | 3.5.16 | 核心框架 |
| **开发语言** | Java | 17 | LTS 版本 |
| **ORM** | MyBatis-Plus | 3.5.16 | 持久层框架 |
| **安全** | Sa-Token | 1.45.0 | 认证授权 |
| **数据库** | MySQL 8.0+ | 8.0+ | 主数据库（支持多库） |
| **缓存** | Redis + Redisson | 3.52.0 | 分布式缓存 |
| **文档** | SpringDoc | 2.8.17 | API 文档 |
| **工具库** | Hutool | 5.8.43 | Java 工具集 |
| **对象转换** | Mapstruct-Plus | 1.5.0 | BO/VO/Entity 映射 |
| **定时任务** | SnailJob | 1.10.0 | 分布式任务调度 |

**注：** 后端为核心项目。如果 `plus-ui/` 目录存在，则包含 PC 管理端前端代码，前端版本见下表。

### 前端技术栈（plus-ui）

| 层级 | 技术栈 | 版本 | 说明 |
|------|--------|------|------|
| **框架** | Vue | 3.5.30 | 组合式 API |
| **UI 组件库** | Element Plus | 2.13.5 | PC 管理端组件 |
| **状态管理** | Pinia | 3.0.4 | 全局状态 |
| **路由** | Vue Router | 5.0.3 | 前端路由 |
| **构建工具** | Vite | 7.3.2 | 开发服务器端口 7070 |
...
┌─────────────────────────────────────────────────────────────┐
│                      后端服务                                │
│           ruoyi-admin (Spring Boot 3.5.16)                  │
├─────────────────────────────────────────────────────────────┤
│  ┌────────────┐ ┌────────────┐ ┌──────────────┐ ┌────────────┐ ┌──────────────┐│
